"""
Feature engineering pipeline for Telecom Capacity Forecasting.
...
class FeatureEngineer:
    ...
    def create_rolling_aggregates(
        ...
        Useful for: traffic trends, capacity utilization over time
    ...
    def create_lag_features(
        ...
        Captures historical patterns at different time horizons:
        - 1h lag: most recent observation
        - 24h lag: same hour yesterday
        - 168h lag: same hour last week
    ...
    def create_interaction_features(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Create capacity-forecasting-specific interaction features.

        Combines traffic, utilization, and user metrics to capture
        ...
        Returns:
            DataFrame with capacity interaction features
        """
        df = df.copy()
    ...
    def pipeline(
        ...
        Includes lag feature creation for time-series forecasting.
...
def main():
    """Run the capacity forecasting feature engineering workflow."""
    # Load raw data
